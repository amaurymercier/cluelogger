...
import { StyleSheet, View, Text, Switch, TextInput, TouchableOpacity, Alert, Linking, Dimensions } from 'react-native'
...
const styles = StyleSheet.create({
  ...
  switch:{
    transform: [{ rotate: "90deg" }, { scaleX: .8 }, { scaleY: .8 }]
  },
